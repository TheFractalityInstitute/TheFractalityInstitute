...
<head>
  ...
  <title>Fractality Bubble UI v13.3 - The Genesis Engine</title>
...
<body>
  <div id="overlay">
    <h3>Fractal Node Information v13.3</h3>
    <div id="info"></div>
  </div>
  ...
  <script>
    // --- WRAP EVERYTHING to ensure all libraries are loaded first ---
    window.addEventListener('DOMContentLoaded', () => {
        ...
        // --- THIS VARIABLE DECLARATION WAS THE FINAL BUG ---
