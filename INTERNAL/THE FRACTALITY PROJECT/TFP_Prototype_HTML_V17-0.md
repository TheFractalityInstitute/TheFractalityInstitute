...
<head>
  ...
  <title>Fractality Bubble UI v17.0 - The Masterpiece</title>
...
<body>
  <div id="overlay">
    <h3>Fractal Node Information v17.0</h3>
    <div id="info"></div>
  </div>
    ...
    window.addEventListener('DOMContentLoaded', () => {
        ...
        function calculateLayout(focusId) {
            ...
            children.forEach((childId, i) => {
                ...
                layout.set(childId, new THREE.Vector3(x, y, z).multiplyScalar(params.nodeSpacing));
            });
            return layout;
        }
        ...
        function setFocus(newFocusId, isInstant = false) {
            ...
            // The critical fix: always reset the camera target to the new layout's center.
        ...
        function populateNodeList() { /* ... identical ... */ }
