...
<head>
  ...
  <title>Fractality Bubble UI v10.0 - The Final Form</title>
...
<body>
  <div id="overlay">
    <h3>Fractal Node Information v10.0</h3>
    <div id="info"></div>
  </div>
  ...
  <script type="module">
    ...
    function calculateLayout(focusId) {
        ...
        children.forEach((childId, i) => {
            const y = 1 - (i / (n === 1 ? 2 : n - 1)) * 2; // Avoid division by zero for single child
