...
<head>
  ...
  <title>Fractality Bubble UI v14.3 - The Stable Step</title>
...
<body>
  <div id="overlay">
    <h3>Fractal Node Information v14.3</h3>
    <div id="info"></div>
  </div>
  ...
  <script>
    window.addEventListener('DOMContentLoaded', () => {
        ...
        function calculateLayout(focusId) {
            ...
            // FIX #1: Correctly center a single child node.
            if (n === 1) {
        ...
        function setFocus(newFocusId) {
            ...
            // FIX #2: Always reset the camera's target to the center of the new layout.
