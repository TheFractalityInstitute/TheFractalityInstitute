...
<head>
  ...
  <title>Fractality Bubble UI v15.1.1 - Stable Editor</title>
...
<body>
  <div id="overlay">
    <h3>Fractal Node Information v15.1.1</h3>
    <div id="info"></div>
  </div>
  ...
  <script>
    window.addEventListener('DOMContentLoaded', () => {
        ...
        // The corrected, robust interaction handler
        ...
        // --- INITIAL SETUP ---
        refreshScene(); // Use refreshScene to build the initial view
