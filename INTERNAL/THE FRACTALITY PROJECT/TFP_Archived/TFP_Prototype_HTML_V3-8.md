...
<head>
  ...
  <title>Fractality Bubble UI v3.8 (Working!)</title>
...
<body>
  <div id="overlay">
    <h3>Fractal Node Information v3.8</h3>
    <div id="info">⟡ Pinch to zoom, drag to explore.</div>
  </div>

  <script type="module">
    // Because of the import map, the browser now knows what "three" means.
    // We also need to get OrbitControls from the three.js module itself now.
    ...
    function handleInteraction(event) {
        ...
        const intersects = raycaster.intersectObjects(node_meshes);
