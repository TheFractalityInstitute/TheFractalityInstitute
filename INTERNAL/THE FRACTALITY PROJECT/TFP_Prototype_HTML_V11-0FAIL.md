...
<head>
  ...
  <title>Fractality Bubble UI v11.0 - The Grand Synthesis</title>
...
<body>
  <div id="overlay">
    <h3>Fractal Node Information v11.0</h3>
    <div id="info"></div>
  </div>
  ...
  <script type="module">
    ...
    // --- Re-introducing the Deterministic Layout Engine ---
    ...
    // --- Re-introducing Interaction & Animation ---
