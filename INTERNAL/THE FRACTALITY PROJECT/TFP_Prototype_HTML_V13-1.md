...
<head>
  ...
  <title>Fractality Bubble UI v13.1 - The Universal Engine</title>
...
<body>
  <div id="overlay">
    <h3>Fractal Node Information v13.1</h3>
    <div id="info"></div>
  </div>
  ...
  <script>
    // This is now a standard script, not a module.
    
    // Immediately wrap in a function to avoid polluting the global scope
    (function () {
        // --- DATA ---
        ...
        // THREE.OrbitControls is now attached to the global THREE object
